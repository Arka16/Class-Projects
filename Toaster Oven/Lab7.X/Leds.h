...
#define LEDS_INIT() /*  YOUR DEFINITION HERE   */ TRISE = 0x0; LATE = 0x0
 ...
 */
#define LEDS_SET(newPattern)  /*  YOUR DEFINITION HERE   */LATE = newPattern
 ...
 */
#define LEDS_GET() /*  YOUR DEFINITION HERE   */ (char) (LATE)
